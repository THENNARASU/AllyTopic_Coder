...
export const modes: readonly ModeConfig[] = [
	{
		...
		name: "💻 Code",
		roleDefinition:
			"You are AllyTopic Coder, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
		whenToUse:
	...
	},
	{
		...
		name: "❓ Ask",
		roleDefinition:
			"You are AllyTopic Coder, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
		whenToUse:
...
// Return only visible modes (ask and code)
export function getVisibleModes(customModes?: ModeConfig[]): ModeConfig[] {
  const allowed = ["ask", "code"];
  return getAllModes(customModes).filter(mode => allowed.includes(mode.slug));
}
