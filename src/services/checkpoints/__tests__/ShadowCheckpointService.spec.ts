...
const initWorkspaceRepo = async ({
	workspaceDir,
	userName = "AllyTopic Coder",
	userEmail = "support@allytopic.com",
	...
	(klass, prefix) => {
		...
		describe(`${klass.name}#hasNestedGitRepositories`, () => {
			it("throws error when nested git repositories are detected during initialization", async () => {
				...
				await mainGit.init()
				await mainGit.addConfig("user.name", "AllyTopic Coder")
				await mainGit.addConfig("user.email", "support@allytopic.com")
				...
				await nestedGit.addConfig("user.name", "AllyTopic Coder")
				await nestedGit.addConfig("user.email", "support@allytopic.com")
