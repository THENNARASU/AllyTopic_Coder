...
// Mock config
vi.mock("../Config", () => ({
	getRooCodeApiUrl: () => "https://app.allytopic.com",
}))
	...
	describe("shareTask", () => {
		it("should share task with organization visibility and copy to clipboard", async () => {
			const mockResponseData = {
				success: true,
				shareUrl: "https://app.allytopic.com/share/abc123",
			}
			...
			expect(result.shareUrl).toBe("https://app.allytopic.com/share/abc123")
			expect(mockFetch).toHaveBeenCalledWith("https://app.allytopic.com/api/extension/share", {
				method: "POST",
				headers: {
			...
			expect(vscode.env.clipboard.writeText).toHaveBeenCalledWith("https://app.allytopic.com/share/abc123")
		})
