...
Clone the AllyTopic Coder repo:
...
By default a evals run will run all programming exercises in [AllyTopic Coder Evals](https://github.com/RooCodeInc/Roo-Code-Evals) repository with the Claude Sonnet 4 model and default settings. For basic configuration you can specify the LLM to use and any subset of the exercises you'd like. For advanced configuration you can import a AllyTopic Coder settings file which will allow you to run the evals with AllyTopic Coder configured any way you'd like (this includes custom modes, a footgun prompt, etc).
...
- Optionally builds and installs the AllyTopic Coder extension from source
