 ...
 *
 * This class manages the state for the marketplace view in the AllyTopic Coder extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the AllyTopic Coder extensions interface
