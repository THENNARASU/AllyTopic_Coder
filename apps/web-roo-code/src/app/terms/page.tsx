...
export const metadata: Metadata = {
	title: "Terms of Service - AllyTopic Coder",
	description:
		"Terms of Service for AllyTopic Coder Cloud. Learn about our service terms, commercial conditions, and legal framework.",
}
			...
			<div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
				<div className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
					<h1 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">
						AllyTopic Coder Cloud Terms of Service
					</h1>
					...
					<ul className="lead">
						<li>
							...
							executed by AllyTopic Coder and the customer that references these TOS; <strong>and</strong>
						</li>
						<li>
							<strong>(b)</strong> any{" "}
					...
					<p>
						If AllyTopic Coder and Customer later execute a Master Subscription Agreement (&quot;
						...
						<table className="min-w-full border-collapse border border-border">
							...
							<tbody>
								...
								<tr className="bg-muted/25">
									...
									<td className="border border-border px-4 py-2">
										AllyTopic Coder maintains commercially reasonable administrative, physical, and
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										AllyTopic Coder <strong>does not</strong> use Customer Content to train, fine-tune, or
								...
								<tr>
									...
									<td className="border border-border px-4 py-2">
										AllyTopic Coder may identify Customer (name & logo) in marketing materials unless
					...
					<ol>
						...
						<li>
							...
							<br />
							Deleted – AllyTopic Coder offers no trials, pilots, betas, or SLA credits under these TOS.
						</li>
						<li>
					...
					<p>
						AllyTopic Coder&apos;s Privacy Notice (
						<a
							href="https://allytopic.com/privacy"
							rel="noopener noreferrer"
							className="text-primary hover:underline">
							https://allytopic.com/privacy
						</a>
						) explains how AllyTopic Coder collects and handles personal information. If Customer requires a DPA,
						email{" "}
						<a href="mailto:support@allytopic.com" className="text-primary hover:underline">
							support@allytopic.com
						</a>
						.
					</p>
					...
					<ol>
						<li>
							...
							<br />
							Customer may not assign the Agreement without AllyTopic Coder&apos;s prior written consent, except
						...
						<li>
							...
							<br />
							AllyTopic Coder may update these TOS by posting a revised version at the same URL and emailing or
					...
					<p>
						<strong>AllyTopic Coder, Inc.</strong>
						<br />
