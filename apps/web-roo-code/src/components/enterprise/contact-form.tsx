...
export function ContactForm({ formType, buttonText, buttonClassName }: ContactFormProps) {
	...
	const formDescription =
		formType === "early-access"
			? "Fill out the form below to collaborate in shaping AllyTopic Coder's enterprise solution."
			: "Fill out the form below to see AllyTopic Coder's enterprise capabilities in action."
